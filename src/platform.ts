...
import { RoomSensorPlatformAccessory } from './platformAccessory';
 ...
 */
export class HoneywellHomeRoomSensorPlatform implements DynamicPlatformPlugin {
                  ...
                  if (findaccessories.accessoryAttribute.type === 'IndoorAirSensor'
                    ...
                    if (existingAccessory) {
                      ...
                      if (device.isAlive) {
                        ...
                        new RoomSensorPlatformAccessory(this, existingAccessory, locationId, device, findaccessories, group);
                      ...
                      // this is imported from `platformAccessory.ts`
                      new RoomSensorPlatformAccessory(this, accessory, locationId, device, findaccessories, group);
